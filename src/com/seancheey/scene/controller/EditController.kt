...
class EditController : Initializable {
    ...
    fun saveEditingRobot() {
        if (selectBotModelIndex != EditController.NONE)
    ...
    /**
     * update the robot model in bot group box to refresh its image
     */
    fun updateRobot() {
        (botGroupBox!!.children[selectBotModelIndex] as ModelSlot).updateModel(getRobotModel())
    }

    /**
     * clear all componentView in editPane
     */
    fun clearComponents() {
